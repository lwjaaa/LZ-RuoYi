<template>
  <el-card>
    <el-tabs
      ...
      type="border-card"
      style="margin-bottom: 30px; min-height: 600px"
    >
      <el-tab-pane
      ...
      >
        ...
        >
          ...
          <el-form-item
            v-if="column.htmlType === 'imageUpload'"
            label="生成数值"
            :rules="[
              {
                required: column.required,
          ...
          <el-form-item
            v-if="column.htmlType === 'fileUpload'"
            label="生成数值"
            :rules="[
              {
                required: column.required,
...
<script>
import { getGenTable, genValue } from "@/api/tool/genvue2";
