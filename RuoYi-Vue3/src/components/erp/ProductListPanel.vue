...
import { UploadFilled, ArrowDown, ArrowUp } from "@element-plus/icons-vue";
...
function openStoreAction(desc: string): void {
...
function handlePushToShopify(): void {
  ...
  openStoreAction(isSelected ? `已勾选的 ${count} 个商品` : `当前筛选的 ${count} 个商品`);
}
