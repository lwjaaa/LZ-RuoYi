...
public class ShopifyTaskEdit implements Serializable
{
     ...
     * 对象转封装类
     *
     * @param shopifyTaskEdit 编辑对象
     * @return ShopifyTask
     */
    public static ShopifyTask editToObj(ShopifyTaskEdit shopifyTaskEdit) {
        if (shopifyTaskEdit == null) {
            return null;
        }
        ShopifyTask shopifyTask = new ShopifyTask();
        BeanUtils.copyProperties(shopifyTaskEdit, shopifyTask);
        return shopifyTask;
    }
}
