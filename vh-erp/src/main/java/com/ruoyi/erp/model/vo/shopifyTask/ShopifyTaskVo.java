...
public class ShopifyTaskVo implements Serializable
{
     ...
     * 对象转封装类
     *
     * @param shopifyTask ShopifyTask实体对象
     * @return ShopifyTaskVo
     */
    public static ShopifyTaskVo objToVo(ShopifyTask shopifyTask) {
        if (shopifyTask == null) {
            return null;
        }
        ShopifyTaskVo shopifyTaskVo = new ShopifyTaskVo();
        BeanUtils.copyProperties(shopifyTask, shopifyTaskVo);
        return shopifyTaskVo;
    }
}
